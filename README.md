...
Objeto `JSON` com dados climáticos
...
## Variáveis de Ambiente:                  
 ...
 ```
 Chave API para a API do OpenWeatherMap.
...
```
 Isso iniciará o servidor de desenvolvimento do Flask, e a API estará disponível em um servidor `WEB`.
...
Para consultar, alterar e executar a API acesse o código que está na branch filial.                                                                                                
